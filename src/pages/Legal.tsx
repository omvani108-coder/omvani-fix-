...
function PrivacyContent() {
  return (
    <div className="prose prose-sm dark:prose-invert max-w-none font-sans">
      ...
      <p>We use browser localStorage to save your preferences (language, theme, notification settings). We do not use third-party tracking cookies or analytics services.</p>

      <h2 className="font-serif">7. Children's Privacy</h2>
      <p>OmVani requires users to confirm they are at least 13 years old during sign-up. We do not knowingly collect personal information from children under 13.</p>

      <h2 className="font-serif">8. Account Deletion</h2>
      ...
      <h2 className="font-serif">9. Your Rights</h2>
      <p>You have the right to access, correct, or delete your personal data. You can export your data or delete your account from the Profile settings page.</p>

      <h2 className="font-serif">10. Contact</h2>
...
function TermsContent() {
  return (
    <div className="prose prose-sm dark:prose-invert max-w-none font-sans">
      ...
      <p>OmVani offers Free, Basic (Sadhak), Pro (Guru), and Family subscription tiers. Paid plans include a 7-day free trial. After the trial, your selected plan will be charged via Razorpay. Subscriptions auto-renew unless cancelled. You can manage or cancel your subscription through your Razorpay account.</p>
