...
function TermsContent() {
  return (
    <div className="prose prose-sm dark:prose-invert max-w-none font-sans">
      ...
      <p>OmVani offers Free, Basic (Sadhak), Pro (Guru), and Family subscription tiers. Paid plans include a 7-day free trial. After the trial, your selected plan will be charged via Razorpay, our payment processor. Subscriptions auto-renew unless cancelled. You can manage or cancel your subscription from your Profile page or by contacting support.</p>
